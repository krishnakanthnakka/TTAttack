...
class VOTVideo(Video):
    ...
    def load_tracker(self, path, tracker_names=None, store=True, trajcase= None):
        """
        Args:
        ...
        for name in tracker_names:
            ...
            if trajcase is None:
                ...
                traj_files = glob(os.path.join(path, name, 'baseline', self.name, '*01_pred.txt'))
...
class VOTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        for video in pbar:
            ...
            # print(meta_data[video]['img_names'],)
            # exit()
