...
def load_generator():
        ...
        # CSA-S
            ...
            attack_method = 'CSA_TS'
            import sys
            sys.path.insert(0, '/cvlabdata1/home/krishna/AttTracker/GIT/CSA/pix2pix')
            ...
            opt.istargeted = False
            os.environ['CUDA_VISIBLE_DEVICES'] = '0'
            opt.eps = args.eps  #CHANGED
            opt.model, expcase, model_epoch, opt.netG = 'G_search_L2_500_regress', args.case, args.model_iter, 'unet_256'
...
def main():
    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if idx == frame_counter:
                    ...
                    outputs = tracker.track_adv(img,hp,  GAN)
            ...
            if args.attack_universal:
                video_path = os.path.join('results_U_{}_{}'.format(attack_method, expcase), args.dataset, model_name,'baseline', video.name)
            else:
                video_path = os.path.join('results_{}_{}'.format(attack_method, expcase), args.dataset, model_name,'baseline', video.name)
        ...
        for v_idx, video in enumerate(dataset):
            ...
            if args.attack_universal:
                model_path = os.path.join('results_U_{}_{}'.format(attack_method, expcase), args.dataset, model_name)
            else:
