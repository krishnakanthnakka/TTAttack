...
for ((CASE=320;CASE<=339;CASE++)); do
    python test_attack_ours_target.py  --dataset OTB100  --snapshot snapshot/model_general.pth   --model_iter=4_net_G.pth --case=$CASE --eps=16 --attack_universal --trajcase=12  --targetcase=12 #--vis
done
