...
python test_attack_csaS.py  --dataset OTB100  --snapshot snapshot/model_general.pth   --model_iter=8_net_G.pth --case=3 --eps=8
python test_attack_csaS.py  --dataset VOT2018  --snapshot snapshot/model_general.pth   --model_iter=8_net_G.pth --case=3 --eps=8
python test_attack_csaS.py  --dataset UAV123  --snapshot snapshot/model_general.pth   --model_iter=8_net_G.pth --case=3 --eps=8
