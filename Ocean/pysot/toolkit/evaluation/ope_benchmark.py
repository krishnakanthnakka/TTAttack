...
class OPEBenchmark:
    ...
    def __init__(self, dataset, model_epoch, expcase):
        ...
        for tracker_name in eval_trackers:
            ...
            for video in self.dataset:
                ...
                if tracker_name not in video.pred_trajs:
                    tracker_traj = video.load_tracker(self.dataset.tracker_path, tracker_name,
                                                      False, self.model_epoch, self.expcase)
    ...
    def eval_precision(self, eval_trackers=None):
        ...
        for tracker_name in eval_trackers:
            ...
            for video in self.dataset:
                ...
                precision_ret_[video.name] = success_error(gt_center, tracker_center, thresholds,
                                                           n_frame)
