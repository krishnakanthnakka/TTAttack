...
from .utils import TrackerParams, FeatureParams, load_yaml, load_pretrain
...
from .models_ocean import models as models
import torch
...
class ONLINE(object):
    ...
    def track(self, bgr_im, image, siam_tracker, siam_state, GAN) -> dict:
        self.debug_info = {}
