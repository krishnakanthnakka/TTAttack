...
python eval_target.py --tracker_path=./results_Universal_Targeted --dataset=OTB100 --model_epoch=4_net_G.pth --case=2 --tracker_prefix=G_template_L2_500_regress_siamrpn_mobilev2_l234_dwxcorr --trajcase=11
