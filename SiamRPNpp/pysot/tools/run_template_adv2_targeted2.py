...
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=30  --targetcase=30 --vis
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=OTB100 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=61  --targetcase=11 --vis
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=UAV123 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=61  --targetcase=11
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr_lt --dataset=VOT2018-LT --case=221 --gpu=1 --model_iter=4_net_G.pth  --trajcase=71  --targetcase=11

python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=OTB100 --case=332 --gpu=1 --model_iter=4_net_G.pth  --trajcase=61  --targetcase=11
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=319 --gpu=1 --model_iter=4_net_G.pth  --trajcase=61  --targetcase=11 --vis

python run_template_adv2_targeted2.py  --tracker_name=siamrpn_alex_dwxcorr --dataset=VOT2018 --case=173 --gpu=1 --model_iter=4_net_G.pth  --trajcase=141  --targetcase=11
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=OTB100 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=11  --targetcase=11 --vis


python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=OTB100 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=21  --targetcase=21  --attack_universal

# lasot
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=lasot --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=11  --targetcase=11  --attack_universal --vis
...
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=OTB100 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=11  --targetcase=11  --attack_universal



# base
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=332 --gpu=1 --model_iter=3_net_G.pth  --trajcase=11  --targetcase=11  --attack_universal
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=332 --gpu=1 --model_iter=3_net_G.pth  --trajcase=12  --targetcase=12  --attack_universal
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=332 --gpu=1 --model_iter=3_net_G.pth  --trajcase=13  --targetcase=13 --attack_universal
python run_template_adv2_targeted2.py  --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=332 --gpu=1 --model_iter=3_net_G.pth  --trajcase=14  --targetcase=14  --attack_universal
            ...
            for idx, (img, gt_bbox) in tqdm(enumerate(video)):
                ...
                if args.vis and idx > 0:
                    ...
                    if 0:
                        ...
                        cv2.putText(search_img, str(idx), (40, 40),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)

                        perturb_img = cv2.cvtColor(perturb_img, cv2.COLOR_BGR2RGB)
                        cv2.putText(perturb_img, str(idx), (40, 40),
