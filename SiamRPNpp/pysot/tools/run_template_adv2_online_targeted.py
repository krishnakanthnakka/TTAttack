...
python run_template_adv2_online_targeted.py  --tracker_name=siam_ocean_online --dataset=OTB100 --case=211 --gpu=1 --model_iter=4_net_G.pth  --trajcase=11  --targetcase=11  --attack_universal --vis
...
def main(cmd_line):
    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            video_path = os.path.join(results_dir, args.dataset, model_name, 'baseline', str(expcase), model_epoch, str(args.trajcase), video.name)
        ...
        for v_idx, video in enumerate(dataset):
            ...
            if 'VOT2018-LT' == args.dataset:
                ...
                model_path = os.path.join(results_dir, args.dataset, model_name, str(expcase), model_epoch,  str(args.trajcase))
                # print(model_path)
