...
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=1  --vis

python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=OTB100 --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=11  --vis
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr_lt --dataset=VOT2018-LT --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=30 --offsetx=0 --offsety=0  --vis
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=VOT2018 --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=30 --offsetx=0 --offsety=0  --vis
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=lasot --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=30 --offsetx=0 --offsety=0  --vis


# for lasot ffor offset based targets
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=lasot --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=11 --offsetx=80 --offsety=80  --vis
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=lasot --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=12 --offsetx=80 --offsety=-80  #--vis
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=lasot --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=13 --offsetx=-80 --offsety=80  #--vis
python run_target_trajectory.py --tracker_name=siamrpn_r50_l234_dwxcorr --dataset=lasot --case=133 --gpu=1 --model_iter=4_net_G.pth --trajcase=14 --offsetx=-80 --offsety=-80  #--vis
...
parser.add_argument('--offsetx', type=int, required=True)
parser.add_argument('--offsety', type=int, required=True)
            ...
            for idx, (img, gt_bbox) in tqdm(enumerate(video)):
                ...
                if idx == 0:
                    ...
                    if(len(gt_bbox) < 4):
                        ...
                        cx, cy, w, h = [(cx - (w - 1) / 2 + args.offsetx), (cy - (h - 1) / 2 +
                                                                            args.offsety), w, h]  # CHANGED THIS INSTEAD OF w,h
