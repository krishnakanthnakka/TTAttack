...
from models_ocean.online.layers.normalization import InstanceL2Norm
from models_ocean.online.layers.transform import InterpCat
...
def residual_basic_block(feature_dim=256, num_blocks=1, l2norm=True, final_conv=False, norm_scale=1.0, out_dim=None,
    ...
    if final_conv:
        feat_layers.append(nn.Conv2d(feature_dim, out_dim,
