...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # change to yours
        parser.add_argument('--name', type=str, default='G_template_L2_500_regress',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--model', type=str, default='G_template_L2_500_regress',
    ...
    def print_options(self, opt, log=print):
