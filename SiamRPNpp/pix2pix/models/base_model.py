...
class BaseModel(ABC):
    ...
    def __init__(self, opt, log):
        ...
        # self.save_dir = os.path.join(opt.checkpoints_dir, opt.name, opt.case)  # save all the checkpoints to save_dir
        self.save_dir = os.path.join(opt.checkpoints_dir, opt.name + "_" + str(opt.case)
