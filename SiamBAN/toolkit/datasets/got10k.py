...
class GOT10kVideo(Video):
    ...
    def load_tracker(self, path, tracker_names=None, store=False):
        """
        Args:
        ...
        for name in tracker_names:
            traj_file = os.path.join(path, name, self.name+'_001.txt') # CHANGED. ADDED 001
            ...
            if os.path.exists(traj_file):
                ...
                return self.pred_trajs[name]

                # print(np.array(self.pred_trajs[name]).shape)
                # exit()
